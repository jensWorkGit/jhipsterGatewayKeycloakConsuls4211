...
@EnableZuulProxy
public class JhipsterGatewayKeycloakConsuls4211App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterGatewayKeycloakConsuls4211App.class);

    private final Environment env;

    public JhipsterGatewayKeycloakConsuls4211App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterGatewayKeycloakConsuls4211.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterGatewayKeycloakConsuls4211App.class);
